...
from taknik.models import Category
from taknik.models import Page
from taknik.models import UserProfile
from taknik.forms import UserForm, UserProfileForm
from taknik.forms import CategoryForm, PageForm
from django.contrib.auth import authenticate, login, logout
from django.http import HttpResponseRedirect
from django.contrib.auth.decorators import login_required
from datetime import datetime
from taknik.bing_search import run_query
...
def index(request):
    ...
    return render_to_response('taknik/index.html', context_dict, context)
...
def about(request):
    ...
    return render_to_response('taknik/about.html', context_dict , context)
...
def category(request, category_name_url):
    ...
    return render_to_response('taknik/category.html', context_dict, context)
...
def add_category(request):
    ...
    return render_to_response('taknik/add_category.html', context_dict, context)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return render_to_response( 'taknik/add_page.html',
                                          context_dict,
                                          context)
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            if user.is_active:
                login(request, user)
                return HttpResponseRedirect('/taknik/')
            # The account is inactive; tell by adding variable to the template context.
            else:
                context_dict['disabled_account'] = True
                return render_to_response('taknik/login.html', context_dict, context)
...
def restricted(request):
    ...
    context_dict = {}
    context_dict['cat_list'] = cat_list
    return render_to_response('taknik/restricted.html', context_dict, context)
...
def search(request):
    ...
    context_dict['result_list'] = result_list
    return render_to_response('taknik/search.html', context_dict, context)
...
def profile(request):
    ...
    return render_to_response('taknik/profile.html', context_dict, context)
...
def suggest_category(request):
    ...
    return render_to_response('taknik/category_list.html', {'cat_list': cat_list }, context)
...
def auto_add_page(request):
    ...
    return render_to_response('taknik/page_list.html', context_dict, context)
